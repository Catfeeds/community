...
public class ProfileInfoResource {
    ...
    public ProfileInfoResource(Environment env, TongWiiProperties jHipsterProperties) {
        this.env = env;
    ...
    private String getRibbonEnv(String[] activeProfiles) {
        String[] displayOnActiveProfiles = tongWiiProperties.getRibbon().getDisplayOnActiveProfiles();
