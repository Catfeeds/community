...
@EnableConfigurationProperties({LiquibaseProperties.class, TongWiiProperties.class})
public class Application {
    ...
    public void initApplication() {
        ...
        if (activeProfiles.contains(TongWiiConstants.SPRING_PROFILE_DEVELOPMENT) && activeProfiles.contains(TongWiiConstants.SPRING_PROFILE_PRODUCTION)) {
